#!/usr/bin/env python
"""Test the Bronkhorst MFC instrument."""
...
def test_output_power():
    ...
    # as cito fait que cito pointe sur l'instrument et ses property
    # expected protocol verifie qeu la ligne cito.output_power = 1 * u.kW envoie cmd_set_1kW à l'instrument et qu'il répond cmd_query
    with expected_protocol(
        ik.comet.CitoPlus1310,
        [
            cmd_set_1kW,
